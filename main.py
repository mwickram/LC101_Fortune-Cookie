...
def getRandomFortune():
    ...
    fortunes = [
        ...
        "You have tamed the mighty Python, now you must "
        "free it onto the Great Spider's Web!"
    ]

    #randomly select one fo the fortunes
...
class MainHandler(webapp2.RequestHandler):
    ...
    def get(self):
        ...
        content = header + fortune_para + number_para + cookie_again_button
